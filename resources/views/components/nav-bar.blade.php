<nav class="bg-[#00795E] shadow-md">
    
    <div class="rounded-b-2 hidden md:flex bg-[#00795E] items-center justify-between container mx-auto px-6 py-5">
    ...
    <div class="rounded-b-2 md:hidden bg-gradient-to-r from-orange-400 to-yellow-500 p-3">
