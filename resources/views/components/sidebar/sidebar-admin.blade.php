        ...
        <nav class="space-y-2">
            <a href="{{ route('admin.profile') }}" 
               @class([
                   ...
                   'text-gray-600 hover:bg-gray-100 hover:text-gray-900' => !Route::is('admin.profile'),
               ])>
                <span>Profil</span>
            </a>

            <a href="{{ route('admin.list-toko') }}" 
               @class([
                   'flex items-center space-x-3 py-2 px-3 rounded-md',
                   'bg-green-100 text-green-700 font-semibold' => Route::is('admin.list-toko'),
                   'text-gray-600 hover:bg-gray-100 hover:text-gray-900' => !Route::is('admin.list-toko'),
               ])>
                <span>List Toko</span>
            </a>
            ...
            <a href="{{ route('admin.list-user') }}" 
               @class([
                   ...
                   'text-gray-600 hover:bg-gray-100 hover:text-gray-900' => !Route::is('admin.list-user'),
               ])>
                <span>List User</span>
            </a>
            ...
            <a href="{{ route('admin.laporan') }}" 
               @class([
                   ...
                   'text-gray-600 hover:bg-gray-100 hover:text-gray-900' => !Route::is('admin.laporan'),
               ])>
