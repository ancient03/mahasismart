...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // If there are no initial reviews, add a class to indicate this.
        if (getReviewItems().length === 0) {
            reviewList.classList.add('no-reviews');
        }
        ...
        function filterReviews(filter) {
            ...
            // If there are no reviews at all, do nothing further.
            if (reviewList.classList.contains('no-reviews')) {
                // Ensure the "no reviews" message passed from the server is not cleared
                return;
            }
