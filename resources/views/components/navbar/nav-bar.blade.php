<nav class="fixed top-0 left-0 w-full z-50 rounded-b-xl bg-[#00795E] shadow-md">
    ...
    <!-- Navbar Mobile -->
    <div class="md:hidden bg-gradient-to-r from-orange-400 to-yellow-500 p-3 rounded-b-xl">
        <div class="flex items-center space-x-2">
            <input 
                type="text" 
                class="flex-grow bg-white rounded-xl py-2 px-4 text-gray-900 placeholder-gray-500 focus:outline-none"
                aria-label="Search"
                placeholder="Cari..."
            >
