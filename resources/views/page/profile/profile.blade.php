...
<section class="md:col-span-3">
                <div class="bg-white text-gray-800 rounded-lg shadow lg:p-6 p-4 md:p-8 mb-96">
                        ...
                        <form method="POST" action="{{ route('profile.update') }}" class="lg:col-span-2 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="username" name="username" 
                                       ...
                                       class="px-2 py-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                            </div>
